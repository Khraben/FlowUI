...
export const FlagFR = ({ className = 'w-6 h-6' }: FlagProps) => (
  <svg className={className} viewBox="0 0 496 496" xmlns="http://www.w3.org/2000/svg">
    <rect x="160" y="80" fill="#FFFFFF" width="176" height="336" />
    <path
      fill="#3757A6"
    ...
    <polygon fill="#133970" points="160,80 48,80 160,112.8" />
  </svg>
);
