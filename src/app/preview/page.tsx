...
import { PREVIEW_CONFIG, PREVIEW_TEXT, FILTER_CATEGORY, COMPONENT_CATEGORIES } from '@/constants';
...
export default function PreviewPage() {
  ...
  const [selectedCategory, setSelectedCategory] = useState<
    ComponentCategory | typeof FILTER_CATEGORY.ALL
  >(FILTER_CATEGORY.ALL);
  ...
  const filteredComponents =
    selectedCategory === FILTER_CATEGORY.ALL
      ? componentRegistry
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#2B2B2B] via-[#313335] to-[#2B2B2B]">
      ...
      <div className="sticky top-[108px] z-40 bg-[#3C3F41]/95 backdrop-blur-md border-b border-[#323232] shadow-lg">
        ...
        {componentsToShow.length === 0 && (
          <div className="flex justify-center items-center py-20">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-[#A9B7C6] mb-2">
                {PREVIEW_TEXT.NO_COMPONENTS_TITLE}
              </h3>
      ...
      <footer className="bg-[#3C3F41] border-t border-[#323232] mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <p className="text-center text-[#808080]">{PREVIEW_TEXT.FOOTER_TEXT}</p>
        </div>
      </footer>
    </div>
  );
