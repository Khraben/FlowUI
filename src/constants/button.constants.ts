...
export const BUTTON_BASE_STYLES =
  'inline-flex items-center justify-center font-medium transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:cursor-not-allowed';

export const BUTTON_VARIANT_STYLES = {
  [BUTTON_VARIANTS.PRIMARY]:
    'bg-[#1E90FF] text-white border-none hover:bg-[#187BCD] disabled:bg-[#5A5A5A] disabled:text-[#808080] focus:ring-[#1E90FF]',
  [BUTTON_VARIANTS.SECONDARY]:
    'bg-transparent text-[#00D4FF] border-2 border-[#00D4FF] hover:bg-[#00D4FF] hover:text-[#1A1A1A] disabled:bg-transparent disabled:border-[#5A5A5A] disabled:text-[#5A5A5A] focus:ring-[#00D4FF]',
  [BUTTON_VARIANTS.SUCCESS]:
    'bg-[#00E676] text-[#1A1A1A] border-none hover:bg-[#00C965] disabled:bg-[#5A5A5A] disabled:text-[#808080] focus:ring-[#00E676]',
  [BUTTON_VARIANTS.DANGER]:
    'bg-[#FF5252] text-white border-none hover:bg-[#E63946] disabled:bg-[#5A5A5A] disabled:text-[#808080] focus:ring-[#FF5252]',
  [BUTTON_VARIANTS.CLOSE]:
    'bg-white/20 border-none text-white hover:bg-white/30 hover:rotate-90 rounded-full w-10 h-10 sm:w-9 sm:h-9',
  [BUTTON_VARIANTS.CLEAR]:
    'absolute right-[2.8125rem] top-1/2 -translate-y-1/2 bg-transparent border-none text-[#00D4FF] hover:bg-[#00D4FF]/10 hover:text-[#00B8E6] z-10 rounded-full min-w-[1.5rem] min-h-[1.5rem] md:right-10 md:min-w-[1.375rem] md:min-h-[1.375rem] sm:right-[2.1875rem] sm:min-w-[1.25rem] sm:min-h-[1.25rem] max-xs:right-[1.875rem] max-xs:min-w-[1.125rem] max-xs:min-h-[1.125rem]',
  [BUTTON_VARIANTS.ICON]:
    'bg-transparent text-[#FF6B35] border-2 border-[#FF6B35] hover:bg-[#FF6B35] hover:text-white disabled:bg-transparent disabled:border-[#5A5A5A] disabled:text-[#5A5A5A] focus:ring-[#FF6B35]',
};
